...
class Pi0_Guidance(_model.BaseModel):
    ...
    def embed_suffix(
        ...
        # obs.state is shape [b, 13] (13 = 7prio + 6force)
    ...
    #     # embed images
    #     for name in obs.images:
    #         image_tokens, _ = self.PaliGemma.img(obs.images[name], train=False) # [b, s, num_classes]
    ...
    #     )
    #     # pdb.set_trace()
    #     suffix_out = self.action_state_attention(suffix_out, decode=False) + suffix_out
    #     v_t = self.action_out_proj(suffix_out[:, -self.action_horizon :])
