...
import openpi.models.pi0_guidance as pi0_guidance
import openpi.models.tokenizer as _tokenizer
import openpi.policies.aloha_policy as aloha_policy
import openpi.policies.droid_policy as droid_policy
import openpi.policies.libero_policy as libero_policy
import openpi.policies.flexiv_policy as flexiv_policy
import openpi.policies.flexiv_policy_qpos_eef_action as flexiv_policy_qpos_eef_action
import openpi.policies.flexiv_policy_eef_pos_eef_action as flexiv_policy_eef_pos_eef_action
import openpi.policies.flexiv_policy_input_force as flexiv_policy_input_force
...
class LeRobotFlexivDataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        data_transforms = _transforms.Group(
            inputs=[flexiv_policy.FlexivInputs(action_dim=model_config.action_dim, model_type=model_config.model_type)],
...
@dataclasses.dataclass(frozen=True)
class LeRobotFlexivQEEFDataConfig(DataConfigFactory):
    """
    This config is used to configure transforms that are applied at various parts of the data pipeline.
    For your own dataset, you can copy this class and modify the transforms to match your dataset based on the
    comments below.
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        # replace the transforms below with your own.
        data_transforms = _transforms.Group(
            inputs=[flexiv_policy_qpos_eef_action.FlexivInputs(action_dim=model_config.action_dim, model_type=model_config.model_type)],
            outputs=[flexiv_policy_qpos_eef_action.FlexivOutputs()],
        )
...
@dataclasses.dataclass(frozen=True)
class LeRobotFlexivInputFDataConfig(DataConfigFactory):
    """
    This config is used to configure transforms that are applied at various parts of the data pipeline.
    For your own dataset, you can copy this class and modify the transforms to match your dataset based on the
    comments below.
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        # replace the transforms below with your own.
        data_transforms = _transforms.Group(
            inputs=[flexiv_policy_input_force.FlexivInputs(action_dim=model_config.action_dim, model_type=model_config.model_type)],
            outputs=[flexiv_policy_input_force.FlexivOutputs()],
        )
...
_CONFIGS = [
    ...
    # the comments below.
    TrainConfig(
        name="pi0_flexiv_lora",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotFlexivDataConfig(
            repo_id="flexiv_box_pp_targetpose",
            base_config=DataConfig(
    ...
    TrainConfig(
        name="pi0_flexiv_lora_qpos_eef_action",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotFlexivQEEFDataConfig(
            repo_id="flexiv_boxppfixed_stateq_actioneef_new",
            base_config=DataConfig(
                local_files_only=True,  # Set to True for local-only datasets.
                prompt_from_task=True,
            ),
    ...
    TrainConfig(
        ...
        data=LeRobotFlexivInputFDataConfig(
            repo_id="flexiv_train/flexiv_1plug_insert_inputForce",
            base_config=DataConfig(
                local_files_only=True,  # Set to True for local-only datasets.
                prompt_from_task=True,
            ),
